...
SELECT
 F.NRO_PRESUPUESTO
,F.SERIE_PRESUPUESTO
,F.CODIGO_CLIENTE_PRESUPUESTO
,F.RAZONSOCIAL_CLIENTE_PRESUPUESTO
,F.NIF_CLIENTE_PRESUPUESTO
,F.MOVIL_CLIENTE_PRESUPUESTO
,F.EMAIL_CLIENTE_PRESUPUESTO
,F.DIRECCION1_CLIENTE_PRESUPUESTO
,F.DIRECCION2_CLIENTE_PRESUPUESTO
,F.POBLACION_CLIENTE_PRESUPUESTO
,F.PROVINCIA_CLIENTE_PRESUPUESTO
,F.CPOSTAL_CLIENTE_PRESUPUESTO
,F.PAIS_CLIENTE_PRESUPUESTO
,F.FECHA_PRESUPUESTO
,F.TOTAL_LIQUIDO_PRESUPUESTO
,F.FORMA_PAGO_PRESUPUESTO
,F.COMENTARIOS_PRESUPUESTO
,F.NOMBRE
,F.APELLIDOS
,C.DIBUJO_PRESUPUESTO
       FROM suboc_presupuestos F
 INNER JOIN suboc_dibujos_presupuestos C
         ON F.NRO_PRESUPUESTO = C.NRO_PRESUPUESTO
        AND F.SERIE_PRESUPUESTO = C.SERIE_PRESUPUESTO;
SET NAMES utf8mb4;
