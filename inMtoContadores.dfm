inherited frmMtoContadores: TfrmMtoContadores
    ...
    inherited tsLista: TTabSheet
      ...
      inherited cxGrdPrincipal: TcxGrid
        ...
        inherited cxGrdDBTabPrin: TcxGridDBTableView
          ...
          object dbcGrdDBTabPrinDEFSIMPL_CONTADOR: TcxGridDBColumn
            Caption = 'Es contador de Factura Simplificada'
            DataBinding.FieldName = 'DEFSIMPL_CONTADOR'
            Width = 322
          end
        end
      end
  ...
  object unqryContadores: TUniQuery
    ...
    SQL.Strings = (
      'SELECT * FROM suboc_contadores')
    BeforePost = unqryContadoresBeforePost
    Left = 520
    Top = 240
  end
end
