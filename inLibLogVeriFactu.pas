...
uses
  ...
  System.Win.Registry, Winapi.Messages, inLibLog,
...
var
  ...
  iContador : Integer;
begin
  if TipoEvento = vfetError then
    Log.LogError(Descripcion + ' Datos: ' + DatosAdicionales +
                                    ' Fac' + Serie + '\' + IntToStr(NumFactura))
  else
    Log.LogInfo(Descripcion + ' Datos: ' + DatosAdicionales +
                                   ' Fac' + Serie + '\' + IntToStr(NumFactura));
  try
