...
begin                        //C:\Users\34667\AppData\Local
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Subocasoft\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Subocasoft\';
end;

function GetLogFolder:String;
begin
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+
                                                      '\Subocasoft\log\archive\');
  ForceDirectories(GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Subocasoft\log\');
  Result := GetSpecialFolderPath(CSIDL_LOCAL_APPDATA)+ '\Subocasoft\log\';
