...
uses
  ...
  inMtoClientes in 'src\UI\Core\inMtoClientes.pas' {frmMtoClientes},
  inMtoGenSearch in 'src\UI\Core\inMtoGenSearch.pas' {frmMtoSearch},
  inMtoFac in 'src\UI\Core\inMtoFac.pas' {frmMtoFac},
  ...
  Vcl.Styles,
  dxCore,
  inMtoArticulos in 'src\UI\Core\inMtoArticulos.pas' {frmMtoArticulos},
  ...
  inMtoHistoriaClientes in 'src\UI\Core\inMtoHistoriaClientes.pas' {frmMtoHistoriaClientes},
  UniDataHistoriaClientes in 'src\Data\UniDataHistoriaClientes.pas' {DMHistoriaClientes: TDataModule},
  inMtoFacturasHistoria in 'src\UI\Core\inMtoFacturasHistoria.pas' {frmFacturasHistoria},
  inMtoOdontologos in 'src\UI\Support\inMtoOdontologos.pas' {frmMtoOdontologos},
  inMtoFormasdePago in 'src\UI\Support\inMtoFormasdePago.pas' {frmMtoFormasdePago},
  inMtoModalFacImp in 'src\UI\Modals\inMtoModalFacImp.pas' {frmPrintFac},
  inMtoPre in 'src\UI\Core\inMtoPre.pas' {frmMtoPre},
  ...
  inMtoPreguntas in 'src\UI\Support\inMtoPreguntas.pas' {frmMtoPreguntas},
  ...
  inMtoPaises in 'src\UI\Support\inMtoPaises.pas' {frmMtoPaises},
