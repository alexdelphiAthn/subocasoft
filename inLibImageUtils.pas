...
class function TImageUtils.ObtenerOrientacionEXIF(const ARutaImagen: string): Integer;
var
  Image: TGPImage;
...
class function TImageUtils.ObtenerFechaExif(const RutaArchivo: string): TDateTime;
var
  ImgData: TImgData;
  sNombreFich: string;
...
begin
  ...
  // Si no tiene formato FE_ o falló el parsing, intentar obtener de metadatos EXIF
