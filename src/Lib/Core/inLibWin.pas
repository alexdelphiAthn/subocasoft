...
begin
  ...
  begin
    // Si tiene BOM, usar esa informaci�n
    Result := bomInfo;
  end
  else
  begin
    // Si no tiene BOM, intentar detecci�n autom�tica de Delphi
    contenido := TStringList.Create;
    try
      ...
      begin
        ...
        begin
          // Intentar detecci�n heur�stica de UTF-8
          ...
          Result.Name := 'Codificaci�n desconocida';
      end;
    finally
      contenido.Free;
    end;
