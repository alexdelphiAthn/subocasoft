...
begin
  ...
  begin
    cxgrdtvVista.GetColumnByFieldName('CODIGO_CLIENTE').Caption := 'Filiaci�n';
    cxgrdtvVista.GetColumnByFieldName('CODIGO_CLIENTE').Width := 60;
    cxgrdtvVista.GetColumnByFieldName('RAZONSOCIAL_CLIENTE').Caption := 'Raz�n Social';
    ...
    cxgrdtvVista.GetColumnByFieldName('MOVIL_CLIENTE').Caption := 'Tel�fono M�vil';
    ...
    cxgrdtvVista.GetColumnByFieldName('DIRECCION1_CLIENTE').Caption := 'Direcci�n';
    cxgrdtvVista.GetColumnByFieldName('DIRECCION1_CLIENTE').Width := 264;
    cxgrdtvVista.GetColumnByFieldName('DIRECCION2_CLIENTE').Caption := 'M�s Direcci�n';
    cxgrdtvVista.GetColumnByFieldName('DIRECCION2_CLIENTE').Width := 102;
    cxgrdtvVista.GetColumnByFieldName('POBLACION_CLIENTE').Caption := 'Poblaci�n';
    ...
    cxgrdtvVista.GetColumnByFieldName('CPOSTAL_CLIENTE').Caption := 'C�digo Postal';
    ...
    cxgrdtvVista.GetColumnByFieldName('PROFESION_CLIENTE').Caption := 'Profesi�n';
  ...
  begin
     cxgrdtvVista.GetColumnByFieldName('CODIGO_ARTICULO').Caption := 'C�digo';
...
begin
  ...
  //grabacion de los campos de la bbdd y columnas del grid, m�scaras...
  {
